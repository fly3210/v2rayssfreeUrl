...
RUN wget -O v2rayssfreeUrl_2.994_linux_386.tar.gz https://github.com/fly3210/v2rayssfreeUrl/releases/download/v2.994/v2rayssfreeUrl_2.991_linux_386.tar.gz
